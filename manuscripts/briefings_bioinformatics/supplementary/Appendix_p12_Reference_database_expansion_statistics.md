...
| Classified (confidence >=40%) | 69,140 (97.0% of reference sequences) |
| Unknown/Novel (confidence <40%) | 2,109 (3.0% of reference sequences) |

Note: Overall classification rate of the full 79,305-plasmid database is 97.3% (77,196 classified; 2,109 low-confidence from reference sequences).
