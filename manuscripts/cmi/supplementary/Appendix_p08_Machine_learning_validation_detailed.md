...
**Clinical interpretation:** The dominance of stop codon and CpG-related features confirms that plasmid classification by 4-mer composition captures genuine phylogenetic signals — not statistical noise. The strong performance of the linear baseline (Logistic Regression F1=0.866 across 28 groups) indicates that ~87% of the classificatory information is linearly separable, with ensemble methods capturing an additional ~3% from nonlinear feature interactions.
