...
- Carries sul1 (61.3%), floR (56.3%), mph(A)/mrx(A) (54.2%), blaTEM-1 (38.0%), mcr-1.1 (36.6%)
- **14.4 mean AMR genes** per plasmid; 44.4% mcr co-carriage (63/142 any mcr variant)
...
- pLIN resolves **3,073 unique strain-level codes** from 8,077 plasmids across 28 replicon groups
- Simpson's Diversity Index: **D = 0.985** (pLIN) vs **D = 0.641** (Inc/rep typing alone)
- **97.8%** of L6 codes (3,006/3,073) contain plasmids from a single Inc/rep group, confirming pLIN captures known taxonomy as an emergent property
...
- Scaled from 8,056 unique training to **79,305 plasmids** (+ 71,249 NCBI RefSeq references)
- Resolves **57,886 unique pLIN codes**
- KNN classifier achieves **97.3% classification rate** (91.1% accuracy across 28 groups, k=5, cosine distance) with 2,109 low-confidence assignments
...
|----------------|------------------------|
| pLIN 671: 100% KPC-positive, 13.2 AMR genes, immediate isolation trigger | "IncN" (shared by >1,000 plasmids with vastly different profiles) |
| Cross-Inc resistance hub exchanging sulfonamide + phenicol + macrolide + colistin resistance | Individual replicon types with no cross-Inc linkage |
