...
def create_lancet_microbe():
    ...
    style_sheet(ws2, "Table 2: pLIN hierarchical threshold definitions",
        ...
        [
            ...
            ["L5", "≤0.010", "~99%", "Clone complex", "Intra-hospital transmission investigation", "Median (d=0.011)"],
            ["L6", "≤0.001", "~99.9%", "Strain / outbreak", "Outbreak confirmation; infection control trigger", "25th percentile (d=0.001)"],
        ],
...
def create_briefings():
    ...
    style_sheet(ws, "Table 1: Comparative evaluation of plasmid classification systems",
        ...
        [
            ...
            ["Resolution", "Strain (~99.9% ANI)", "Family", "Sub-family (ST)", "Species (Mash 0.06)", "Species", "Variable"],
    ...
    style_sheet(ws2, "Table 2: pLIN threshold definitions and clustering results",
        ...
        [
            ...
            ["L5", "E", "≤0.010", "~99%", "Clone complex", 117, 82, 36100],
            ["L6", "F", "≤0.001", "~99.9%", "Strain/outbreak", 3073, 2335, 57886],
        ],
...
def create_microbial_genomics():
    ...
    style_sheet(ws, "Table 1: Comparative evaluation of plasmid typing systems",
        ...
        [
            ...
            ["Resolution", "Strain (~99.9% ANI)", "Family", "Sub-family", "Species", "Species", "Variable"],
    ...
    style_sheet(ws2, "Table 2: pLIN hierarchical thresholds and clustering results (n=8,077)",
        ...
        [
            ...
            ["L5", "Clone complex", "≤0.010", "~99%", 117, 6737, 82],
            ["L6", "Strain", "≤0.001", "~99.9%", 3073, 869, 2335],
        ],
...
def create_cmi():
    ...
    style_sheet(ws2, "Table 2: pLIN thresholds, ANI equivalence, and clinical interpretation",
        ...
        [
            ...
            ["L5", "≤0.010", "~99%", "98.2%", "Clone complex", "Intra-hospital; ward-level spread"],
            ["L6", "≤0.001", "~99.9%", "99.9%", "Strain/outbreak", "Outbreak confirmation; direct transmission"],
        ],
...
def add_appendix_sheets(wb):
    ...
    style_sheet(ws, "Appendix p 9: Hierarchical threshold calibration (IncX n=178 + FastANI n=4,970)",
        ...
        [
            ...
            ["25th percentile", "0.001", "L6 threshold (strain/outbreak)"],
